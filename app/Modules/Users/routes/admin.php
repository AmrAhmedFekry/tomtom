...
Route::group([
    ...
    Route::patch('/users/notification/seen/{id}', 'NotificationController@markAsSeen');
    Route::get('/users/notification', 'NotificationController@list');
    Route::delete('/users/notification/remove/{id}', 'NotificationController@remove');
    Route::delete('/users/notification/remove', 'NotificationController@removeAll');
});
